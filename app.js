...
const db = mysql.createConnection({
    ...
    host: '1debzn.h.filess.io',
    user: 'C237db_hundredwhy',
    port: 3307,
    password: '60f27748a6fc60c9f26d4fb93e7caadfa7fcacf9',
    database: 'C237db'
});
...
const validateRegistration = (req, res, next) => {
    ...
    next(); //if all validations passes, the next function in the middleware stack is called, 
            // allowing the request to proceed to the next middleware or route handler.
};
...
app.get('/login', (req, res) => {
    // Render the login page with any flash messages
    res.render('login', { 
